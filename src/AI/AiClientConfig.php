...
final class AiClientConfig
{
    public function __construct(
        public readonly string $apiKey,
        public readonly string $model,
        public readonly string $baseUrl,
        public readonly string $chatCompletionsPath,
        public readonly int $timeoutSeconds,
        public readonly string $authHeaderName,
        public readonly string $authPrefix,
        public readonly ?string $organization,
        public readonly ?string $project,
        public readonly ?string $systemPromptOverride,
        public readonly ?string $caInfoPath,
    ...
    private static function envStringAllowEmpty(string $name): ?string
    {
        ...
        // Do NOT trim: some prefixes intentionally require a trailing space (e.g. "Bearer ").
        return $value;
    }
